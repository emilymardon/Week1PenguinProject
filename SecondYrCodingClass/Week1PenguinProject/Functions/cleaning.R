...
clean_column_names <- function(penguins_data) {
  print("Cleaning up column names into snake_case.")
  penguins_data %>%
    clean_names()
}
...
remove_columns <- function(penguins_data, column_names) {
  print("Removing column names based on a vector of column names.")
  penguins_data %>%
...
shorten_species <- function(penguins_data) {
  print("Shortening species names in our data.")
  penguins_data %>%
...
remove_empty_columns_rows <- function(penguins_data) {
  print("Removing empty columns or rows.")
  penguins_data %>%
...
remove_NA <- function(penguins_data) {
  print("Removing rows which contain NA")
  penguins_data %>%
    na.omit()
}
